...
Route<dynamic> generateRoute(RouteSettings settings){
  switch (settings.name){
    ...
    case "advertiser":
      return MaterialPageRoute(builder: (_)=> const DevicesListScreen(deviceType: DeviceType.advertiser));
    default:
...
class Home extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context){
    return Scaffold(appBar: AppBar(title: const Text("Ulak")),
    body: Column(
      children:[
        Expanded(child: InkWell(
          ...
          child: Container(
            color:Colors.red,
            child:const Center(child: Text("Browser",
        ...
        Expanded(child: InkWell(
          ...
          child:Container(
            color:Colors.green,
            child:const Center(child: Text("advertiser",style:TextStyle(color:Colors.white, fontSize: 40)
            ),)
          )
        ))
      ]
...
class _DevicesListScreenState extends State<DevicesListScreen> {
  ...
  Widget build(BuildContext context){
    return Scaffold(
      appBar: AppBar(title: Text(widget.deviceType.toString().substring(11).toUpperCase()),),
   ...
   subscription = nearbyService.stateChangedSubscription(
        callback: (deviceList) {
          ...
          setState(() {
            ...
            connectedDevices.addAll(deviceList.where((d)=>d.state
            ==SessionState.connected).toList());
          });
        }
   ); 
